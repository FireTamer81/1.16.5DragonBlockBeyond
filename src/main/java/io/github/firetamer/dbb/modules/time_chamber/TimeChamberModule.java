package io.github.firetamer.dbb.modules.time_chamber;
...
import io.github.firetamer.dbb.modules.time_chamber.blocks.TimeChamberPortalBlock;
...
@Module(id = @RL(modid = DragonBlockBeyond.MOD_ID, path = "time_chamber_door_feature"))
public class TimeChamberModule extends ModuleHelper implements IModule {

    @AutoBlockItem
    @RegisterBlock("time_chamber_door")
    public static final TimeChamberDoorBlock TIME_CHAMBER_DOOR_BLOCK = new TimeChamberDoorBlock();

    @RegisterTileEntityType("time_chamber_door_tile")
    public static final TileEntityType<TimeChamberDoorTile> TIME_CHAMBER_DOOR_TILE = TileEntityType.Builder
            .of(TimeChamberDoorTile::new, TIME_CHAMBER_DOOR_BLOCK).build(null);
    ...
    public void onClientSetup(FMLClientSetupEvent event) {
        ClientRegistry.bindTileEntityRenderer(TIME_CHAMBER_DOOR_TILE, TimeChamberDoorRenderer::new);
    ...
    private static void setDimensionEffects() {
        ResourceLocation TIME_CHAMBER_ID = new ResourceLocation(DragonBlockBeyond.MOD_ID, "time_chamber_dimension");
