...
import io.github.firetamer.dbb.modules.strong_block.util.ModelHelper;
...
public class WarenaiBlockModel implements IDynamicBakedModel {
	...
	public List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction side, @Nonnull Random rand,
		...
		if (state.getValue(WarenaiBlock.BLOCK_CONDITION) == WarenaiBlockCondition.POLISHED) {
			allQuads.addAll(ModelHelper.createCuboid(0f, 1f, 0f, 1f, 0f, 1f, polishedUnderlayTexture, 0, renderNorth,
					renderEast, renderSouth, renderWest, renderUp, renderDown));
		} else if (state.getValue(WarenaiBlock.BLOCK_CONDITION) == WarenaiBlockCondition.NORMAL) {
			allQuads.addAll(ModelHelper.createCuboid(0f, 1f, 0f, 1f, 0f, 1f, underlayTexture, 0, renderNorth,
					renderEast, renderSouth, renderWest, renderUp, renderDown));
		} else if (state.getValue(WarenaiBlock.BLOCK_CONDITION) == WarenaiBlockCondition.SCUFFED) {
			allQuads.addAll(ModelHelper.createCuboid(0f, 1f, 0f, 1f, 0f, 1f, underlayTexture, 0, renderNorth,
					renderEast, renderSouth, renderWest, renderUp, renderDown));
			allQuads.addAll(ModelHelper.createCuboid(0f, 1f, 0f, 1f, 0f, 1f, scuffed_OverlayTexture, 0, renderNorth,
					renderEast, renderSouth, renderWest, renderUp, renderDown));
		} else if (state.getValue(WarenaiBlock.BLOCK_CONDITION) == WarenaiBlockCondition.CRACKED1) {
			allQuads.addAll(ModelHelper.createCuboid(0f, 1f, 0f, 1f, 0f, 1f, underlayTexture, 0, renderNorth,
					renderEast, renderSouth, renderWest, renderUp, renderDown));
			allQuads.addAll(ModelHelper.createCuboid(0f, 1f, 0f, 1f, 0f, 1f, c1_OverlayTexture, 0, renderNorth,
					renderEast, renderSouth, renderWest, renderUp, renderDown));
		} else if (state.getValue(WarenaiBlock.BLOCK_CONDITION) == WarenaiBlockCondition.CRACKED2) {
			allQuads.addAll(ModelHelper.createCuboid(0f, 1f, 0f, 1f, 0f, 1f, underlayTexture, 0, renderNorth,
					renderEast, renderSouth, renderWest, renderUp, renderDown));
			allQuads.addAll(ModelHelper.createCuboid(0f, 1f, 0f, 1f, 0f, 1f, c2_OverlayTexture, 0, renderNorth,
					renderEast, renderSouth, renderWest, renderUp, renderDown));
		} else if (state.getValue(WarenaiBlock.BLOCK_CONDITION) == WarenaiBlockCondition.CRACKED3) {
			allQuads.addAll(ModelHelper.createCuboid(0f, 1f, 0f, 1f, 0f, 1f, underlayTexture, 0, renderNorth,
					renderEast, renderSouth, renderWest, renderUp, renderDown));
			allQuads.addAll(ModelHelper.createCuboid(0f, 1f, 0f, 1f, 0f, 1f, c3_OverlayTexture, 0, renderNorth,
					renderEast, renderSouth, renderWest, renderUp, renderDown));
		} else if (state.getValue(WarenaiBlock.BLOCK_CONDITION) == WarenaiBlockCondition.CRACKED4) {
			allQuads.addAll(ModelHelper.createCuboid(0f, 1f, 0f, 1f, 0f, 1f, underlayTexture, 0, renderNorth,
					renderEast, renderSouth, renderWest, renderUp, renderDown));
			allQuads.addAll(ModelHelper.createCuboid(0f, 1f, 0f, 1f, 0f, 1f, c4_OverlayTexture, 0, renderNorth,
					renderEast, renderSouth, renderWest, renderUp, renderDown));
		}
