...
public class PaintMixerContainer extends Container {
    ...
    public PaintMixerContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInv, PlayerEntity player) {
        ...
        layoutPlayerInventorySlots(83, 100); //This controls the position of the slots, don't know how this would be done with movable elements though.

        //This adds the extra slots that aren't included in the player inventory
        if (tileEntity != null) {
