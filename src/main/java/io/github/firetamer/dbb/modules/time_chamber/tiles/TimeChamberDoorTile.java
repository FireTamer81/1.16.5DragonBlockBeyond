package io.github.firetamer.dbb.modules.time_chamber.tiles;
...
public class TimeChamberDoorTile extends TileEntity implements IAnimatable {
    ...
    private <E extends TileEntity & IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        ...
        if (event.getAnimatable().getLevel().getBlockState(thisPos).getValue(TimeChamberDoorBlock.IS_OPEN) == false) {
