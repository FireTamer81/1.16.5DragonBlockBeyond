...
public class PlayerStatGui extends Screen {
    public static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(DBB_Main.MOD_ID, "textures/gui/player_stat_menu_2.png");
    public static final ResourceLocation BUTTONS_TEXTURE = new ResourceLocation(DBB_Main.MOD_ID, "textures/gui/player_stat_menu_buttons.png");
